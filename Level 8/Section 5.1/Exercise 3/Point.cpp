...
string Point::ToString() const {
	...
	temp << "Point(" << x << "," << y << ")" << " Shape Description " << s;//returning the description about the point's coordinates and appending shape's ToString
	return temp.str();
}
...
//Draw method being overridden in point class
void Point::Draw() const {
	cout << "Point is drawn " << x << " " << y << endl;
}