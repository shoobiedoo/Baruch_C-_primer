...
int main()
{
	...
	pt.X(x);//setting the user entered x value using the SETX method
	pt.Y(y);//setting the user entered y value using the SETY method
	cout << "The x coordinate of point 1 using getX function is " << pt.X() << endl;//Printing the x coordinate using the GETX function to check the overall functionality
	cout << "The y coordinate of point 1 using getY function is " << pt.Y() << endl;//Printing the y coordinate using the GETY function to check the overall functionality
