...
{
	/*
	Removed ToString() method in all the cout statements wherever we were displaying the description
	of the circle line or point 
	*/
	...
	cout << "The center point of Circle using the getter centerPoint() is " << c.centerPoint() << endl;
	cout << "The radius of Circle using the getter Radius() is " << c.Radius() << endl;
	cout << "The description of the Circle : " << c << endl;//displaying the description of the Circle
	...
	cout << "The description of the circle C2: " << c2 << endl;
	c2 = c;//checking the assignment operator
	cout << "Assigning C2 = C ; now C2 is " << c2 << endl;
