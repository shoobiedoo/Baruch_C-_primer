...
Circle::Circle() : radius(0),cPoint() // default constructor using colon syntax
{
...
Circle::Circle(double r, const Point& pt) : radius(r),cPoint(pt) //parameterized constructor using colon syntax
{
